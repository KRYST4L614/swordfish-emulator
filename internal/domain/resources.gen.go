...
const (
	...
	ProtocolProtocolUEC             ProtocolProtocol = "UEC"
...
// Defines values for RedundancyV150RedundancyMode.
const (
	Failover     RedundancyV150RedundancyMode = "Failover"
	NM           RedundancyV150RedundancyMode = "N+m"
	NotRedundant RedundancyV150RedundancyMode = "NotRedundant"
	Sharing      RedundancyV150RedundancyMode = "Sharing"
	Sparing      RedundancyV150RedundancyMode = "Sparing"
)
...
// Defines values for ResourceV1210DurableNameFormat.
const (
	EUI        ResourceV1210DurableNameFormat = "EUI"
	FCWWN      ResourceV1210DurableNameFormat = "FC_WWN"
	GCXLID     ResourceV1210DurableNameFormat = "GCXLID"
	IQN        ResourceV1210DurableNameFormat = "iQN"
	MACAddress ResourceV1210DurableNameFormat = "MACAddress"
	NAA        ResourceV1210DurableNameFormat = "NAA"
	NGUID      ResourceV1210DurableNameFormat = "NGUID"
	NQN        ResourceV1210DurableNameFormat = "NQN"
	NSID       ResourceV1210DurableNameFormat = "NSID"
	UUID       ResourceV1210DurableNameFormat = "UUID"
)

// Defines values for ResourceV1210LocationType.
const (
	Backplane ResourceV1210LocationType = "Backplane"
	Bay       ResourceV1210LocationType = "Bay"
	Connector ResourceV1210LocationType = "Connector"
	Embedded  ResourceV1210LocationType = "Embedded"
	Slot      ResourceV1210LocationType = "Slot"
	Socket    ResourceV1210LocationType = "Socket"
)

// Defines values for ResourceV1210Orientation.
const (
	ResourceV1210OrientationBackToFront ResourceV1210Orientation = "BackToFront"
	ResourceV1210OrientationBottomToTop ResourceV1210Orientation = "BottomToTop"
	ResourceV1210OrientationFrontToBack ResourceV1210Orientation = "FrontToBack"
	ResourceV1210OrientationLeftToRight ResourceV1210Orientation = "LeftToRight"
	ResourceV1210OrientationRightToLeft ResourceV1210Orientation = "RightToLeft"
	ResourceV1210OrientationTopToBottom ResourceV1210Orientation = "TopToBottom"
)

// Defines values for ResourceV1210RackUnits.
const (
	EIA310 ResourceV1210RackUnits = "EIA_310"
	OpenU  ResourceV1210RackUnits = "OpenU"
)

// Defines values for ResourceV1210Reference.
const (
	Bottom ResourceV1210Reference = "Bottom"
	Front  ResourceV1210Reference = "Front"
	Left   ResourceV1210Reference = "Left"
	Middle ResourceV1210Reference = "Middle"
	Rear   ResourceV1210Reference = "Rear"
	Right  ResourceV1210Reference = "Right"
	Top    ResourceV1210Reference = "Top"
)

// Defines values for StorageControllerV191ANAAccessState.
const (
	Inaccessible   StorageControllerV191ANAAccessState = "Inaccessible"
	NonOptimized   StorageControllerV191ANAAccessState = "NonOptimized"
	Optimized      StorageControllerV191ANAAccessState = "Optimized"
	PersistentLoss StorageControllerV191ANAAccessState = "PersistentLoss"
)

// Defines values for StorageControllerV191NVMeControllerType.
const (
	Admin     StorageControllerV191NVMeControllerType = "Admin"
	Discovery StorageControllerV191NVMeControllerType = "Discovery"
	IO        StorageControllerV191NVMeControllerType = "IO"
)
...
// CapacityCapacity This is the schema definition for the Capacity of a device. It represents the properties for capacity for any data store.
type CapacityCapacity struct {
	// Data The capacity of specific data type in a data store.
	Data *CapacityCapacityInfo `json:"Data,omitempty"`
	...
	Metadata *CapacityCapacityInfo `json:"Metadata,omitempty"`

	// Snapshot The capacity of specific data type in a data store.
	Snapshot *CapacityCapacityInfo `json:"Snapshot,omitempty"`
}

// CapacityCapacityInfo The capacity of specific data type in a data store.
type CapacityCapacityInfo struct {
...
// CapacityV122Actions The available actions for this resource.
type CapacityV122Actions struct {
	// Oem The available OEM specific actions for this resource.
	Oem *CapacityV122OemActions `json:"Oem,omitempty"`
}

// CapacityV122CapacitySource A description of the type and source of storage.
type CapacityV122CapacitySource struct {
	...
	Actions     *CapacityV122Actions                    `json:"Actions,omitempty"`
	Description *CapacityV122CapacitySource_Description `json:"Description,omitempty"`
	...
	ProvidedCapacity *CapacityCapacity `json:"ProvidedCapacity,omitempty"`
...
// CapacityV122CapacitySourceDescription1 defines model for .
type CapacityV122CapacitySourceDescription1 = interface{}

// CapacityV122CapacitySource_Description defines model for CapacityV122CapacitySource.Description.
type CapacityV122CapacitySource_Description struct {
	union json.RawMessage
}

// CapacityV122OemActions The available OEM specific actions for this resource.
type CapacityV122OemActions map[string]interface{}
...
type ChassisV1250Chassis struct {
	...
	Location *ResourceV1210Location `json:"Location,omitempty"`
	...
	// Deprecated:
	Measurements *[]SoftwareInventoryV1110MeasurementBlock `json:"Measurements,omitempty"`
...
type ComputerSystemV1230ComputerSystem struct {
	...
	Redundancy *[]RedundancyV150Redundancy `json:"Redundancy,omitempty"`
...
// Fabric The `Fabric` schema represents a simple fabric consisting of one or more switches, zero or more endpoints, and zero or more zones.
type Fabric = FabricV132Fabric

// FabricCollection The collection of `Fabric` resource instances.
type FabricCollection = FabricCollectionFabricCollection
...
type FabricCollectionFabricCollection struct {
	...
	// OdataType The type of a resource.
	OdataType   *OdataV4Type                                  `json:"@odata.type,omitempty"`
	Description *FabricCollectionFabricCollection_Description `json:"Description,omitempty"`
...
// FabricCollectionFabricCollectionDescription1 defines model for .
type FabricCollectionFabricCollectionDescription1 = interface{}

// FabricCollectionFabricCollection_Description defines model for FabricCollectionFabricCollection.Description.
type FabricCollectionFabricCollection_Description struct {
	union json.RawMessage
}

// FabricV132Actions The available actions for this resource.
type FabricV132Actions struct {
	// Oem The available OEM-specific actions for this resource.
	Oem *FabricV132OemActions `json:"Oem,omitempty"`
}

// FabricV132Fabric The `Fabric` schema represents a simple fabric consisting of one or more switches, zero or more endpoints, and zero or more zones.
type FabricV132Fabric struct {
	// OdataContext The OData description of a payload.
	OdataContext *OdataV4Context `json:"@odata.context,omitempty"`
	...
	// Actions The available actions for this resource.
	Actions *FabricV132Actions `json:"Actions,omitempty"`

	// AddressPools A reference to a resource.
	...
	Description *FabricV132Fabric_Description `json:"Description,omitempty"`
	...
	// FabricType The protocol being sent over this fabric.
	FabricType *FabricV132Fabric_FabricType `json:"FabricType,omitempty"`

	// Id The unique identifier for this resource within the collection of similar resources.
	Id ResourceId `json:"Id"`

	// Links The links to other resources that are related to this resource.
	Links *FabricV132Links `json:"Links,omitempty"`

	// MaxZones The maximum number of zones the switch can currently configure.
	MaxZones *int64 `json:"MaxZones"`
	...
	// Switches A reference to a resource.
	Switches *OdataV4IdRef `json:"Switches,omitempty"`

	// UUID The UUID for this fabric.
	UUID *FabricV132Fabric_UUID `json:"UUID,omitempty"`

	// Zones A reference to a resource.
	Zones *OdataV4IdRef `json:"Zones,omitempty"`
}

// FabricV132FabricDescription1 defines model for .
type FabricV132FabricDescription1 = interface{}

// FabricV132Fabric_Description defines model for FabricV132Fabric.Description.
type FabricV132Fabric_Description struct {
	union json.RawMessage
}

// FabricV132FabricFabricType1 defines model for .
type FabricV132FabricFabricType1 = interface{}

// FabricV132Fabric_FabricType The protocol being sent over this fabric.
type FabricV132Fabric_FabricType struct {
	union json.RawMessage
}

// FabricV132FabricUUID1 defines model for .
type FabricV132FabricUUID1 = interface{}

// FabricV132Fabric_UUID The UUID for this fabric.
type FabricV132Fabric_UUID struct {
	union json.RawMessage
}

// FabricV132Links The links to other resources that are related to this resource.
type FabricV132Links struct {
	// Oem The OEM extension.
	Oem *ResourceOem `json:"Oem,omitempty"`
}

// FabricV132OemActions The available OEM-specific actions for this resource.
type FabricV132OemActions map[string]interface{}
...
type FileSystemV141FileSystem struct {
	...
	Capacity *CapacityCapacity `json:"Capacity,omitempty"`

	// CapacitySources An array of capacity sources for the file system.
	CapacitySources *[]CapacityV122CapacitySource `json:"CapacitySources,omitempty"`
	...
	Identifiers *[]ResourceV1210Identifier `json:"Identifiers,omitempty"`
	...
	RemainingCapacity *CapacityCapacity `json:"RemainingCapacity,omitempty"`
...
// PCIeDeviceV1180PCIeInterface Properties that describe a PCIe interface.
type PCIeDeviceV1180PCIeInterface struct {
	...
	MaxPCIeType *PCIeDeviceV1180PCIeInterface_MaxPCIeType `json:"MaxPCIeType,omitempty"`

	// Oem The OEM extension.
	Oem *ResourceOem `json:"Oem,omitempty"`

	// PCIeType The version of the PCIe specification in use by this device.
	PCIeType *PCIeDeviceV1180PCIeInterface_PCIeType `json:"PCIeType,omitempty"`
}

// PCIeDeviceV1180PCIeInterfaceMaxPCIeType1 defines model for .
type PCIeDeviceV1180PCIeInterfaceMaxPCIeType1 = interface{}

// PCIeDeviceV1180PCIeInterface_MaxPCIeType The highest version of the PCIe specification supported by this device.
type PCIeDeviceV1180PCIeInterface_MaxPCIeType struct {
	union json.RawMessage
}

// PCIeDeviceV1180PCIeInterfacePCIeType1 defines model for .
type PCIeDeviceV1180PCIeInterfacePCIeType1 = interface{}

// PCIeDeviceV1180PCIeInterface_PCIeType The version of the PCIe specification in use by this device.
type PCIeDeviceV1180PCIeInterface_PCIeType struct {
	union json.RawMessage
}
...
// RedundancyV150Actions The available actions for this resource.
type RedundancyV150Actions struct {
	// Oem The available OEM-specific actions for this resource.
	Oem *RedundancyV150OemActions `json:"Oem,omitempty"`
}

// RedundancyV150OemActions The available OEM-specific actions for this resource.
type RedundancyV150OemActions map[string]interface{}

// RedundancyV150Redundancy The common redundancy definition and structure used in other Redfish schemas.
type RedundancyV150Redundancy struct {
	// OdataId The unique identifier for a resource.
	OdataId *OdataV4Id `json:"@odata.id,omitempty"`

	// Actions The available actions for this resource.
	Actions *RedundancyV150Actions `json:"Actions,omitempty"`
	...
	Mode RedundancyV150Redundancy_Mode `json:"Mode"`
...
// RedundancyV150RedundancyMode1 defines model for .
type RedundancyV150RedundancyMode1 = interface{}

// RedundancyV150Redundancy_Mode The redundancy mode of the group.
type RedundancyV150Redundancy_Mode struct {
	union json.RawMessage
}

// RedundancyV150RedundancyMode defines model for Redundancy_v1_5_0_RedundancyMode.
type RedundancyV150RedundancyMode string
...
// ResourceV1210ContactInfo Contact information for this resource.
type ResourceV1210ContactInfo struct {
...
// ResourceV1210DurableNameFormat defines model for Resource_v1_21_0_DurableNameFormat.
...
type ResourceV1210Identifier struct {
	...
	DurableNameFormat *ResourceV1210Identifier_DurableNameFormat `json:"DurableNameFormat,omitempty"`
}

// ResourceV1210IdentifierDurableNameFormat1 defines model for .
type ResourceV1210IdentifierDurableNameFormat1 = interface{}

// ResourceV1210Identifier_DurableNameFormat The format of the durable name property.
type ResourceV1210Identifier_DurableNameFormat struct {
	union json.RawMessage
}
...
type ResourceV1210Location struct {
	...
	Contacts *[]ResourceV1210Location_Contacts_Item `json:"Contacts,omitempty"`
	...
	PartLocation *ResourceV1210PartLocation `json:"PartLocation,omitempty"`
	...
	PhysicalAddress *ResourceV1210PhysicalAddress `json:"PhysicalAddress,omitempty"`

	// Placement The placement within the addressed location.
	Placement *ResourceV1210Placement `json:"Placement,omitempty"`

	// PostalAddress The postal address for a resource.
	// Deprecated:
	PostalAddress *ResourceV1210PostalAddress `json:"PostalAddress,omitempty"`
}

// ResourceV1210LocationContacts1 defines model for .
type ResourceV1210LocationContacts1 = interface{}

// ResourceV1210Location_Contacts_Item defines model for Resource_v1_21_0_Location.Contacts.Item.
type ResourceV1210Location_Contacts_Item struct {
	union json.RawMessage
}

// ResourceV1210LocationType The types of locations for a part within an enclosure.
type ResourceV1210LocationType string

// ResourceV1210Orientation The orientations for the ordering of the part location ordinal value.
type ResourceV1210Orientation string

// ResourceV1210PartLocation The part location for a resource within an enclosure.
type ResourceV1210PartLocation struct {
	...
	LocationType *ResourceV1210PartLocation_LocationType `json:"LocationType,omitempty"`

	// Orientation The orientation for the ordering of the slot enumeration used by the `LocationOrdinalValue` property.
	Orientation *ResourceV1210PartLocation_Orientation `json:"Orientation,omitempty"`

	// Reference The reference point for the part location.  Provides guidance about the general location of the part.
	Reference *ResourceV1210PartLocation_Reference `json:"Reference,omitempty"`

	// ServiceLabel The label of the part location, such as a silk-screened name or a printed label.
	ServiceLabel *string `json:"ServiceLabel"`
}

// ResourceV1210PartLocationLocationType1 defines model for .
type ResourceV1210PartLocationLocationType1 = interface{}

// ResourceV1210PartLocation_LocationType The type of location of the part.
type ResourceV1210PartLocation_LocationType struct {
	union json.RawMessage
}

// ResourceV1210PartLocationOrientation1 defines model for .
type ResourceV1210PartLocationOrientation1 = interface{}

// ResourceV1210PartLocation_Orientation The orientation for the ordering of the slot enumeration used by the `LocationOrdinalValue` property.
type ResourceV1210PartLocation_Orientation struct {
	union json.RawMessage
}

// ResourceV1210PartLocationReference1 defines model for .
type ResourceV1210PartLocationReference1 = interface{}

// ResourceV1210PartLocation_Reference The reference point for the part location.  Provides guidance about the general location of the part.
type ResourceV1210PartLocation_Reference struct {
	union json.RawMessage
}

// ResourceV1210PhysicalAddress The physical address for a resource.
type ResourceV1210PhysicalAddress struct {
...
// ResourceV1210Placement The placement within the addressed location.
type ResourceV1210Placement struct {
	...
	RackOffsetUnits *ResourceV1210Placement_RackOffsetUnits `json:"RackOffsetUnits,omitempty"`

	// Row The name of the row.
	Row *string `json:"Row"`
}

// ResourceV1210PlacementRackOffsetUnits1 defines model for .
type ResourceV1210PlacementRackOffsetUnits1 = interface{}

// ResourceV1210Placement_RackOffsetUnits The type of rack units in use.
type ResourceV1210Placement_RackOffsetUnits struct {
	union json.RawMessage
}

// ResourceV1210PostalAddress The postal address for a resource.
type ResourceV1210PostalAddress struct {
...
// ResourceV1210RackUnits The type of rack unit in use.
type ResourceV1210RackUnits string

// ResourceV1210Reference The reference areas for the location of the part within an enclosure.
type ResourceV1210Reference string
...
// SoftwareInventoryV1110MeasurementBlock The DSP0274-defined measurement block information.
type SoftwareInventoryV1110MeasurementBlock struct {
...
// StorageController The `StorageController` schema describes a storage controller and its properties.  A storage controller represents a physical or virtual storage device that produces volumes.
type StorageController = StorageControllerV191StorageController

// StorageControllerCollection The collection of `StorageController` resource instances.
type StorageControllerCollection = StorageControllerCollectionStorageControllerCollection
...
type StorageControllerCollectionStorageControllerCollection struct {
	...
	// OdataType The type of a resource.
	OdataType   *OdataV4Type                                                        `json:"@odata.type,omitempty"`
	Description *StorageControllerCollectionStorageControllerCollection_Description `json:"Description,omitempty"`
...
// StorageControllerCollectionStorageControllerCollectionDescription1 defines model for .
type StorageControllerCollectionStorageControllerCollectionDescription1 = interface{}

// StorageControllerCollectionStorageControllerCollection_Description defines model for StorageControllerCollectionStorageControllerCollection.Description.
type StorageControllerCollectionStorageControllerCollection_Description struct {
	union json.RawMessage
}

// StorageControllerV191ANAAccessState defines model for StorageController_v1_9_1_ANAAccessState.
type StorageControllerV191ANAAccessState string

// StorageControllerV191ANACharacteristics The ANA characteristics and volume information for a storage controller.
type StorageControllerV191ANACharacteristics struct {
	// AccessState Reported ANA access state.
	AccessState *StorageControllerV191ANACharacteristics_AccessState `json:"AccessState,omitempty"`

	// Volume A reference to a resource.
	Volume *OdataV4IdRef `json:"Volume,omitempty"`
}

// StorageControllerV191ANACharacteristicsAccessState1 defines model for .
type StorageControllerV191ANACharacteristicsAccessState1 = interface{}

// StorageControllerV191ANACharacteristics_AccessState Reported ANA access state.
type StorageControllerV191ANACharacteristics_AccessState struct {
	union json.RawMessage
}

// StorageControllerV191Actions The available actions for this resource.
type StorageControllerV191Actions struct {
	// HashStorageControllerAttachNamespaces This action attaches referenced namespaces to the storage controller.  Attached namespaces are added to the `AttachedVolumes` property in `Links`.
	HashStorageControllerAttachNamespaces *StorageControllerV191AttachNamespaces `json:"#StorageController.AttachNamespaces,omitempty"`

	// HashStorageControllerDetachNamespaces This action detaches referenced namespaces from the storage controller.  Detached namespaces are removed from the `AttachedVolumes` property in `Links`.
	HashStorageControllerDetachNamespaces *StorageControllerV191DetachNamespaces `json:"#StorageController.DetachNamespaces,omitempty"`

	// HashStorageControllerSecurityReceive This action transfers security protocol data from the controller.  The data transferred from the controller contains the status and data result of one or more `SecuritySend` action requests that were previously submitted to the controller.
	HashStorageControllerSecurityReceive *StorageControllerV191SecurityReceive `json:"#StorageController.SecurityReceive,omitempty"`

	// HashStorageControllerSecuritySend This action transfers security protocol data to the controller.  The data transferred to the controller contains security protocol-specific commands to be performed by the controller.
	HashStorageControllerSecuritySend *StorageControllerV191SecuritySend `json:"#StorageController.SecuritySend,omitempty"`

	// Oem The available OEM-specific actions for this resource.
	Oem *StorageControllerV191OemActions `json:"Oem,omitempty"`
}

// StorageControllerV191AttachNamespaces This action attaches referenced namespaces to the storage controller.  Attached namespaces are added to the `AttachedVolumes` property in `Links`.
type StorageControllerV191AttachNamespaces struct {
	// Target Link to invoke action
	Target *string `json:"target,omitempty"`
...
// StorageControllerV191CacheSummary This type describes the cache memory of the storage controller in general detail.
type StorageControllerV191CacheSummary struct {
...
// StorageControllerV191DetachNamespaces This action detaches referenced namespaces from the storage controller.  Detached namespaces are removed from the `AttachedVolumes` property in `Links`.
type StorageControllerV191DetachNamespaces struct {
	// Target Link to invoke action
	Target *string `json:"target,omitempty"`
...
// StorageControllerV191Links The links to other resources that are related to this resource.
type StorageControllerV191Links struct {
	// AttachedVolumes An array of links to volumes that are attached to this controller instance.
	AttachedVolumes *[]OdataV4IdRef `json:"AttachedVolumes,omitempty"`

	// AttachedVolumesOdataCount The number of items in a collection.
	AttachedVolumesOdataCount *OdataV4Count `json:"AttachedVolumes@odata.count,omitempty"`

	// Batteries The batteries that provide power to this storage controller during a power-loss event.
	Batteries *[]OdataV4IdRef `json:"Batteries,omitempty"`

	// BatteriesOdataCount The number of items in a collection.
	BatteriesOdataCount *OdataV4Count `json:"Batteries@odata.count,omitempty"`
	...
	// NVMeDiscoveredSubsystems The NVMe subsystems discovered by this discovery controller.
	NVMeDiscoveredSubsystems *[]OdataV4IdRef `json:"NVMeDiscoveredSubsystems,omitempty"`

	// NVMeDiscoveredSubsystemsOdataCount The number of items in a collection.
	NVMeDiscoveredSubsystemsOdataCount *OdataV4Count `json:"NVMeDiscoveredSubsystems@odata.count,omitempty"`
...
// StorageControllerV191NVMeControllerAttributes The NVMe controller attributes for a storage controller.
type StorageControllerV191NVMeControllerAttributes struct {
	// ReportsNamespaceGranularity Indicates whether or not the controller supports reporting of Namespace Granularity.
	ReportsNamespaceGranularity *bool `json:"ReportsNamespaceGranularity"`

	// ReportsUUIDList Indicates whether or not the controller supports reporting of a UUID list.
	ReportsUUIDList *bool `json:"ReportsUUIDList"`

	// Supports128BitHostId Indicates whether or not the controller supports a 128-bit Host Identifier.
	Supports128BitHostId *bool `json:"Supports128BitHostId"`

	// SupportsEnduranceGroups Indicates whether or not the controller supports Endurance Groups.
	SupportsEnduranceGroups *bool `json:"SupportsEnduranceGroups"`

	// SupportsExceedingPowerOfNonOperationalState Indicates whether or not the controller supports exceeding Power of Non-Operational State in order to execute controller-initiated background operations in a non-operational power state.
	SupportsExceedingPowerOfNonOperationalState *bool `json:"SupportsExceedingPowerOfNonOperationalState"`

	// SupportsNVMSets Indicates whether or not the controller supports NVM Sets.
	SupportsNVMSets *bool `json:"SupportsNVMSets"`

	// SupportsPredictableLatencyMode Indicates whether or not the controller supports Predictable Latency Mode.
	SupportsPredictableLatencyMode *bool `json:"SupportsPredictableLatencyMode"`

	// SupportsReadRecoveryLevels Indicates whether or not the controller supports Read Recovery Levels.
	SupportsReadRecoveryLevels *bool `json:"SupportsReadRecoveryLevels"`

	// SupportsReservations Indicates if the controller supports reservations.
	SupportsReservations *bool `json:"SupportsReservations"`

	// SupportsSQAssociations Indicates whether or not the controller supports SQ Associations.
	SupportsSQAssociations *bool `json:"SupportsSQAssociations"`

	// SupportsTrafficBasedKeepAlive Indicates whether or not the controller supports restarting the Keep Alive Timer if traffic is processed from an admin command or I/O during a Keep Alive Timeout interval.
	SupportsTrafficBasedKeepAlive *bool `json:"SupportsTrafficBasedKeepAlive"`
}

// StorageControllerV191NVMeControllerProperties NVMe-related properties for a storage controller.
type StorageControllerV191NVMeControllerProperties struct {
	// ANACharacteristics The ANA characteristics and volume information.
	ANACharacteristics *[]StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item `json:"ANACharacteristics,omitempty"`

	// AllocatedCompletionQueues The number of I/O completion queues allocated to this NVMe I/O controller.
	AllocatedCompletionQueues *int64 `json:"AllocatedCompletionQueues"`

	// AllocatedSubmissionQueues The number of I/O submission queues allocated to this NVMe I/O controller.
	AllocatedSubmissionQueues *int64 `json:"AllocatedSubmissionQueues"`

	// ControllerType The type of NVMe controller.
	ControllerType *StorageControllerV191NVMeControllerProperties_ControllerType `json:"ControllerType,omitempty"`

	// DiscoveryTransportServiceId The NVMe discovery transport service identifier for the discovery controller.
	DiscoveryTransportServiceId *int64 `json:"DiscoveryTransportServiceId"`

	// MaxAttachedNamespaces The maximum number of attached namespaces allowed by this NVMe I/O controller.
	MaxAttachedNamespaces *int64 `json:"MaxAttachedNamespaces"`

	// MaxQueueSize The maximum individual queue size that an NVMe I/O controller supports.
	MaxQueueSize *int64 `json:"MaxQueueSize"`

	// NVMeControllerAttributes The NVMe controller attributes.
	NVMeControllerAttributes *StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes `json:"NVMeControllerAttributes,omitempty"`

	// NVMeSMARTCriticalWarnings The NVMe SMART Critical Warnings for this storage controller.  This property contains possible triggers for the predictive drive failure warning for the corresponding drive.
	NVMeSMARTCriticalWarnings *StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings `json:"NVMeSMARTCriticalWarnings,omitempty"`

	// NVMeVersion The version of the NVMe Base Specification supported.
	NVMeVersion *string `json:"NVMeVersion"`
}

// StorageControllerV191NVMeControllerPropertiesANACharacteristics1 defines model for .
type StorageControllerV191NVMeControllerPropertiesANACharacteristics1 = interface{}

// StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item defines model for StorageController_v1_9_1_NVMeControllerProperties.ANACharacteristics.Item.
type StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item struct {
	union json.RawMessage
}

// StorageControllerV191NVMeControllerPropertiesControllerType1 defines model for .
type StorageControllerV191NVMeControllerPropertiesControllerType1 = interface{}

// StorageControllerV191NVMeControllerProperties_ControllerType The type of NVMe controller.
type StorageControllerV191NVMeControllerProperties_ControllerType struct {
	union json.RawMessage
}

// StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1 defines model for .
type StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1 = interface{}

// StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes The NVMe controller attributes.
type StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes struct {
	union json.RawMessage
}

// StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1 defines model for .
type StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1 = interface{}

// StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings The NVMe SMART Critical Warnings for this storage controller.  This property contains possible triggers for the predictive drive failure warning for the corresponding drive.
type StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings struct {
	union json.RawMessage
}

// StorageControllerV191NVMeControllerType defines model for StorageController_v1_9_1_NVMeControllerType.
type StorageControllerV191NVMeControllerType string

// StorageControllerV191NVMeSMARTCriticalWarnings The NVMe SMART Critical Warnings for a storage controller.
type StorageControllerV191NVMeSMARTCriticalWarnings struct {
	// MediaInReadOnly Indicates the media has been placed in read-only mode.
	MediaInReadOnly *bool `json:"MediaInReadOnly"`

	// OverallSubsystemDegraded Indicates that the NVM subsystem reliability has been compromised.
	OverallSubsystemDegraded *bool `json:"OverallSubsystemDegraded"`

	// PMRUnreliable The Persistent Memory Region has become unreliable.
	PMRUnreliable *bool `json:"PMRUnreliable"`

	// PowerBackupFailed Indicates that the volatile memory backup device has failed.
	PowerBackupFailed *bool `json:"PowerBackupFailed"`

	// SpareCapacityWornOut Indicates that the available spare capacity has fallen below the threshold.
	SpareCapacityWornOut *bool `json:"SpareCapacityWornOut"`
}

// StorageControllerV191OemActions The available OEM-specific actions for this resource.
type StorageControllerV191OemActions map[string]interface{}

// StorageControllerV191Rates This type describes the various controller rates used for processes such as volume rebuild or consistency checks.
type StorageControllerV191Rates struct {
...
// StorageControllerV191SecurityReceive This action transfers security protocol data from the controller.  The data transferred from the controller contains the status and data result of one or more `SecuritySend` action requests that were previously submitted to the controller.
type StorageControllerV191SecurityReceive struct {
	// Target Link to invoke action
	Target *string `json:"target,omitempty"`
...
// StorageControllerV191SecuritySend This action transfers security protocol data to the controller.  The data transferred to the controller contains security protocol-specific commands to be performed by the controller.
type StorageControllerV191SecuritySend struct {
	// Target Link to invoke action
	Target *string `json:"target,omitempty"`
...
// StorageControllerV191StorageController The `StorageController` schema describes a storage controller and its properties.  A storage controller represents a physical or virtual storage device that produces volumes.
type StorageControllerV191StorageController struct {
	// OdataContext The OData description of a payload.
	OdataContext *OdataV4Context `json:"@odata.context,omitempty"`
	...
	// Actions The available actions for this resource.
	Actions *StorageControllerV191Actions `json:"Actions,omitempty"`
	...
	CacheSummary *StorageControllerV191CacheSummary `json:"CacheSummary,omitempty"`
	...
	ControllerRates *StorageControllerV191Rates                         `json:"ControllerRates,omitempty"`
	Description     *StorageControllerV191StorageController_Description `json:"Description,omitempty"`
	...
	// Links The links to other resources that are related to this resource.
	Links *StorageControllerV191Links `json:"Links,omitempty"`
	...
	// Metrics The link to the metrics associated with this storage controller.
	Metrics *StorageControllerV191StorageController_Metrics `json:"Metrics,omitempty"`

	// Model The model number for the storage controller.
	Model *string `json:"Model"`

	// NVMeControllerProperties NVMe-related properties for a storage controller.
	NVMeControllerProperties *StorageControllerV191NVMeControllerProperties `json:"NVMeControllerProperties,omitempty"`
	...
	PCIeInterface *PCIeDeviceV1180PCIeInterface `json:"PCIeInterface,omitempty"`
	...
	SupportedRAIDTypes *[]StorageControllerV191StorageController_SupportedRAIDTypes_Item `json:"SupportedRAIDTypes,omitempty"`
}

// StorageControllerV191StorageControllerDescription1 defines model for .
type StorageControllerV191StorageControllerDescription1 = interface{}

// StorageControllerV191StorageController_Description defines model for StorageControllerV191StorageController.Description.
type StorageControllerV191StorageController_Description struct {
	union json.RawMessage
}

// StorageControllerV191StorageControllerMetrics1 defines model for .
type StorageControllerV191StorageControllerMetrics1 = interface{}

// StorageControllerV191StorageController_Metrics The link to the metrics associated with this storage controller.
type StorageControllerV191StorageController_Metrics struct {
	union json.RawMessage
}

// StorageControllerV191StorageControllerSupportedRAIDTypes1 defines model for .
type StorageControllerV191StorageControllerSupportedRAIDTypes1 = interface{}

// StorageControllerV191StorageController_SupportedRAIDTypes_Item defines model for StorageController_v1_9_1_StorageController.SupportedRAIDTypes.Item.
type StorageControllerV191StorageController_SupportedRAIDTypes_Item struct {
	union json.RawMessage
}
...
type StoragePoolV190StoragePool struct {
	...
	Identifier *ResourceV1210Identifier `json:"Identifier,omitempty"`
...
// AsResourceDescription returns the union data inside the CapacityV122CapacitySource_Description as a ResourceDescription
func (t CapacityV122CapacitySource_Description) AsResourceDescription() (ResourceDescription, error) {
	var body ResourceDescription
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceDescription overwrites any union data inside the CapacityV122CapacitySource_Description as the provided ResourceDescription
func (t *CapacityV122CapacitySource_Description) FromResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceDescription performs a merge with any union data inside the CapacityV122CapacitySource_Description, using the provided ResourceDescription
func (t *CapacityV122CapacitySource_Description) MergeResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsCapacityV122CapacitySourceDescription1 returns the union data inside the CapacityV122CapacitySource_Description as a CapacityV122CapacitySourceDescription1
func (t CapacityV122CapacitySource_Description) AsCapacityV122CapacitySourceDescription1() (CapacityV122CapacitySourceDescription1, error) {
	var body CapacityV122CapacitySourceDescription1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCapacityV122CapacitySourceDescription1 overwrites any union data inside the CapacityV122CapacitySource_Description as the provided CapacityV122CapacitySourceDescription1
func (t *CapacityV122CapacitySource_Description) FromCapacityV122CapacitySourceDescription1(v CapacityV122CapacitySourceDescription1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCapacityV122CapacitySourceDescription1 performs a merge with any union data inside the CapacityV122CapacitySource_Description, using the provided CapacityV122CapacitySourceDescription1
func (t *CapacityV122CapacitySource_Description) MergeCapacityV122CapacitySourceDescription1(v CapacityV122CapacitySourceDescription1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t CapacityV122CapacitySource_Description) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *CapacityV122CapacitySource_Description) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
// AsResourceDescription returns the union data inside the FabricCollectionFabricCollection_Description as a ResourceDescription
func (t FabricCollectionFabricCollection_Description) AsResourceDescription() (ResourceDescription, error) {
	var body ResourceDescription
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceDescription overwrites any union data inside the FabricCollectionFabricCollection_Description as the provided ResourceDescription
func (t *FabricCollectionFabricCollection_Description) FromResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceDescription performs a merge with any union data inside the FabricCollectionFabricCollection_Description, using the provided ResourceDescription
func (t *FabricCollectionFabricCollection_Description) MergeResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsFabricCollectionFabricCollectionDescription1 returns the union data inside the FabricCollectionFabricCollection_Description as a FabricCollectionFabricCollectionDescription1
func (t FabricCollectionFabricCollection_Description) AsFabricCollectionFabricCollectionDescription1() (FabricCollectionFabricCollectionDescription1, error) {
	var body FabricCollectionFabricCollectionDescription1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromFabricCollectionFabricCollectionDescription1 overwrites any union data inside the FabricCollectionFabricCollection_Description as the provided FabricCollectionFabricCollectionDescription1
func (t *FabricCollectionFabricCollection_Description) FromFabricCollectionFabricCollectionDescription1(v FabricCollectionFabricCollectionDescription1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeFabricCollectionFabricCollectionDescription1 performs a merge with any union data inside the FabricCollectionFabricCollection_Description, using the provided FabricCollectionFabricCollectionDescription1
func (t *FabricCollectionFabricCollection_Description) MergeFabricCollectionFabricCollectionDescription1(v FabricCollectionFabricCollectionDescription1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t FabricCollectionFabricCollection_Description) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *FabricCollectionFabricCollection_Description) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceDescription returns the union data inside the FabricV132Fabric_Description as a ResourceDescription
func (t FabricV132Fabric_Description) AsResourceDescription() (ResourceDescription, error) {
	var body ResourceDescription
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceDescription overwrites any union data inside the FabricV132Fabric_Description as the provided ResourceDescription
func (t *FabricV132Fabric_Description) FromResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceDescription performs a merge with any union data inside the FabricV132Fabric_Description, using the provided ResourceDescription
func (t *FabricV132Fabric_Description) MergeResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsFabricV132FabricDescription1 returns the union data inside the FabricV132Fabric_Description as a FabricV132FabricDescription1
func (t FabricV132Fabric_Description) AsFabricV132FabricDescription1() (FabricV132FabricDescription1, error) {
	var body FabricV132FabricDescription1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromFabricV132FabricDescription1 overwrites any union data inside the FabricV132Fabric_Description as the provided FabricV132FabricDescription1
func (t *FabricV132Fabric_Description) FromFabricV132FabricDescription1(v FabricV132FabricDescription1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeFabricV132FabricDescription1 performs a merge with any union data inside the FabricV132Fabric_Description, using the provided FabricV132FabricDescription1
func (t *FabricV132Fabric_Description) MergeFabricV132FabricDescription1(v FabricV132FabricDescription1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t FabricV132Fabric_Description) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *FabricV132Fabric_Description) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsProtocolProtocol returns the union data inside the FabricV132Fabric_FabricType as a ProtocolProtocol
func (t FabricV132Fabric_FabricType) AsProtocolProtocol() (ProtocolProtocol, error) {
	var body ProtocolProtocol
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromProtocolProtocol overwrites any union data inside the FabricV132Fabric_FabricType as the provided ProtocolProtocol
func (t *FabricV132Fabric_FabricType) FromProtocolProtocol(v ProtocolProtocol) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeProtocolProtocol performs a merge with any union data inside the FabricV132Fabric_FabricType, using the provided ProtocolProtocol
func (t *FabricV132Fabric_FabricType) MergeProtocolProtocol(v ProtocolProtocol) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsFabricV132FabricFabricType1 returns the union data inside the FabricV132Fabric_FabricType as a FabricV132FabricFabricType1
func (t FabricV132Fabric_FabricType) AsFabricV132FabricFabricType1() (FabricV132FabricFabricType1, error) {
	var body FabricV132FabricFabricType1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromFabricV132FabricFabricType1 overwrites any union data inside the FabricV132Fabric_FabricType as the provided FabricV132FabricFabricType1
func (t *FabricV132Fabric_FabricType) FromFabricV132FabricFabricType1(v FabricV132FabricFabricType1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeFabricV132FabricFabricType1 performs a merge with any union data inside the FabricV132Fabric_FabricType, using the provided FabricV132FabricFabricType1
func (t *FabricV132Fabric_FabricType) MergeFabricV132FabricFabricType1(v FabricV132FabricFabricType1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t FabricV132Fabric_FabricType) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *FabricV132Fabric_FabricType) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceUUID returns the union data inside the FabricV132Fabric_UUID as a ResourceUUID
func (t FabricV132Fabric_UUID) AsResourceUUID() (ResourceUUID, error) {
	var body ResourceUUID
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceUUID overwrites any union data inside the FabricV132Fabric_UUID as the provided ResourceUUID
func (t *FabricV132Fabric_UUID) FromResourceUUID(v ResourceUUID) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceUUID performs a merge with any union data inside the FabricV132Fabric_UUID, using the provided ResourceUUID
func (t *FabricV132Fabric_UUID) MergeResourceUUID(v ResourceUUID) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsFabricV132FabricUUID1 returns the union data inside the FabricV132Fabric_UUID as a FabricV132FabricUUID1
func (t FabricV132Fabric_UUID) AsFabricV132FabricUUID1() (FabricV132FabricUUID1, error) {
	var body FabricV132FabricUUID1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromFabricV132FabricUUID1 overwrites any union data inside the FabricV132Fabric_UUID as the provided FabricV132FabricUUID1
func (t *FabricV132Fabric_UUID) FromFabricV132FabricUUID1(v FabricV132FabricUUID1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeFabricV132FabricUUID1 performs a merge with any union data inside the FabricV132Fabric_UUID, using the provided FabricV132FabricUUID1
func (t *FabricV132Fabric_UUID) MergeFabricV132FabricUUID1(v FabricV132FabricUUID1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t FabricV132Fabric_UUID) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *FabricV132Fabric_UUID) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
// AsPCIeDevicePCIeTypes returns the union data inside the PCIeDeviceV1180PCIeInterface_MaxPCIeType as a PCIeDevicePCIeTypes
func (t PCIeDeviceV1180PCIeInterface_MaxPCIeType) AsPCIeDevicePCIeTypes() (PCIeDevicePCIeTypes, error) {
	var body PCIeDevicePCIeTypes
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPCIeDevicePCIeTypes overwrites any union data inside the PCIeDeviceV1180PCIeInterface_MaxPCIeType as the provided PCIeDevicePCIeTypes
func (t *PCIeDeviceV1180PCIeInterface_MaxPCIeType) FromPCIeDevicePCIeTypes(v PCIeDevicePCIeTypes) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePCIeDevicePCIeTypes performs a merge with any union data inside the PCIeDeviceV1180PCIeInterface_MaxPCIeType, using the provided PCIeDevicePCIeTypes
func (t *PCIeDeviceV1180PCIeInterface_MaxPCIeType) MergePCIeDevicePCIeTypes(v PCIeDevicePCIeTypes) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsPCIeDeviceV1180PCIeInterfaceMaxPCIeType1 returns the union data inside the PCIeDeviceV1180PCIeInterface_MaxPCIeType as a PCIeDeviceV1180PCIeInterfaceMaxPCIeType1
func (t PCIeDeviceV1180PCIeInterface_MaxPCIeType) AsPCIeDeviceV1180PCIeInterfaceMaxPCIeType1() (PCIeDeviceV1180PCIeInterfaceMaxPCIeType1, error) {
	var body PCIeDeviceV1180PCIeInterfaceMaxPCIeType1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPCIeDeviceV1180PCIeInterfaceMaxPCIeType1 overwrites any union data inside the PCIeDeviceV1180PCIeInterface_MaxPCIeType as the provided PCIeDeviceV1180PCIeInterfaceMaxPCIeType1
func (t *PCIeDeviceV1180PCIeInterface_MaxPCIeType) FromPCIeDeviceV1180PCIeInterfaceMaxPCIeType1(v PCIeDeviceV1180PCIeInterfaceMaxPCIeType1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePCIeDeviceV1180PCIeInterfaceMaxPCIeType1 performs a merge with any union data inside the PCIeDeviceV1180PCIeInterface_MaxPCIeType, using the provided PCIeDeviceV1180PCIeInterfaceMaxPCIeType1
func (t *PCIeDeviceV1180PCIeInterface_MaxPCIeType) MergePCIeDeviceV1180PCIeInterfaceMaxPCIeType1(v PCIeDeviceV1180PCIeInterfaceMaxPCIeType1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t PCIeDeviceV1180PCIeInterface_MaxPCIeType) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *PCIeDeviceV1180PCIeInterface_MaxPCIeType) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsPCIeDevicePCIeTypes returns the union data inside the PCIeDeviceV1180PCIeInterface_PCIeType as a PCIeDevicePCIeTypes
func (t PCIeDeviceV1180PCIeInterface_PCIeType) AsPCIeDevicePCIeTypes() (PCIeDevicePCIeTypes, error) {
	var body PCIeDevicePCIeTypes
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPCIeDevicePCIeTypes overwrites any union data inside the PCIeDeviceV1180PCIeInterface_PCIeType as the provided PCIeDevicePCIeTypes
func (t *PCIeDeviceV1180PCIeInterface_PCIeType) FromPCIeDevicePCIeTypes(v PCIeDevicePCIeTypes) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePCIeDevicePCIeTypes performs a merge with any union data inside the PCIeDeviceV1180PCIeInterface_PCIeType, using the provided PCIeDevicePCIeTypes
func (t *PCIeDeviceV1180PCIeInterface_PCIeType) MergePCIeDevicePCIeTypes(v PCIeDevicePCIeTypes) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsPCIeDeviceV1180PCIeInterfacePCIeType1 returns the union data inside the PCIeDeviceV1180PCIeInterface_PCIeType as a PCIeDeviceV1180PCIeInterfacePCIeType1
func (t PCIeDeviceV1180PCIeInterface_PCIeType) AsPCIeDeviceV1180PCIeInterfacePCIeType1() (PCIeDeviceV1180PCIeInterfacePCIeType1, error) {
	var body PCIeDeviceV1180PCIeInterfacePCIeType1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPCIeDeviceV1180PCIeInterfacePCIeType1 overwrites any union data inside the PCIeDeviceV1180PCIeInterface_PCIeType as the provided PCIeDeviceV1180PCIeInterfacePCIeType1
func (t *PCIeDeviceV1180PCIeInterface_PCIeType) FromPCIeDeviceV1180PCIeInterfacePCIeType1(v PCIeDeviceV1180PCIeInterfacePCIeType1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePCIeDeviceV1180PCIeInterfacePCIeType1 performs a merge with any union data inside the PCIeDeviceV1180PCIeInterface_PCIeType, using the provided PCIeDeviceV1180PCIeInterfacePCIeType1
func (t *PCIeDeviceV1180PCIeInterface_PCIeType) MergePCIeDeviceV1180PCIeInterfacePCIeType1(v PCIeDeviceV1180PCIeInterfacePCIeType1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t PCIeDeviceV1180PCIeInterface_PCIeType) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *PCIeDeviceV1180PCIeInterface_PCIeType) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsRedundancyV150RedundancyMode returns the union data inside the RedundancyV150Redundancy_Mode as a RedundancyV150RedundancyMode
func (t RedundancyV150Redundancy_Mode) AsRedundancyV150RedundancyMode() (RedundancyV150RedundancyMode, error) {
	var body RedundancyV150RedundancyMode
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromRedundancyV150RedundancyMode overwrites any union data inside the RedundancyV150Redundancy_Mode as the provided RedundancyV150RedundancyMode
func (t *RedundancyV150Redundancy_Mode) FromRedundancyV150RedundancyMode(v RedundancyV150RedundancyMode) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeRedundancyV150RedundancyMode performs a merge with any union data inside the RedundancyV150Redundancy_Mode, using the provided RedundancyV150RedundancyMode
func (t *RedundancyV150Redundancy_Mode) MergeRedundancyV150RedundancyMode(v RedundancyV150RedundancyMode) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsRedundancyV150RedundancyMode1 returns the union data inside the RedundancyV150Redundancy_Mode as a RedundancyV150RedundancyMode1
func (t RedundancyV150Redundancy_Mode) AsRedundancyV150RedundancyMode1() (RedundancyV150RedundancyMode1, error) {
	var body RedundancyV150RedundancyMode1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromRedundancyV150RedundancyMode1 overwrites any union data inside the RedundancyV150Redundancy_Mode as the provided RedundancyV150RedundancyMode1
func (t *RedundancyV150Redundancy_Mode) FromRedundancyV150RedundancyMode1(v RedundancyV150RedundancyMode1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeRedundancyV150RedundancyMode1 performs a merge with any union data inside the RedundancyV150Redundancy_Mode, using the provided RedundancyV150RedundancyMode1
func (t *RedundancyV150Redundancy_Mode) MergeRedundancyV150RedundancyMode1(v RedundancyV150RedundancyMode1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t RedundancyV150Redundancy_Mode) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *RedundancyV150Redundancy_Mode) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
// AsResourceV1210DurableNameFormat returns the union data inside the ResourceV1210Identifier_DurableNameFormat as a ResourceV1210DurableNameFormat
func (t ResourceV1210Identifier_DurableNameFormat) AsResourceV1210DurableNameFormat() (ResourceV1210DurableNameFormat, error) {
	var body ResourceV1210DurableNameFormat
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210DurableNameFormat overwrites any union data inside the ResourceV1210Identifier_DurableNameFormat as the provided ResourceV1210DurableNameFormat
func (t *ResourceV1210Identifier_DurableNameFormat) FromResourceV1210DurableNameFormat(v ResourceV1210DurableNameFormat) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210DurableNameFormat performs a merge with any union data inside the ResourceV1210Identifier_DurableNameFormat, using the provided ResourceV1210DurableNameFormat
func (t *ResourceV1210Identifier_DurableNameFormat) MergeResourceV1210DurableNameFormat(v ResourceV1210DurableNameFormat) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsResourceV1210IdentifierDurableNameFormat1 returns the union data inside the ResourceV1210Identifier_DurableNameFormat as a ResourceV1210IdentifierDurableNameFormat1
func (t ResourceV1210Identifier_DurableNameFormat) AsResourceV1210IdentifierDurableNameFormat1() (ResourceV1210IdentifierDurableNameFormat1, error) {
	var body ResourceV1210IdentifierDurableNameFormat1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210IdentifierDurableNameFormat1 overwrites any union data inside the ResourceV1210Identifier_DurableNameFormat as the provided ResourceV1210IdentifierDurableNameFormat1
func (t *ResourceV1210Identifier_DurableNameFormat) FromResourceV1210IdentifierDurableNameFormat1(v ResourceV1210IdentifierDurableNameFormat1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210IdentifierDurableNameFormat1 performs a merge with any union data inside the ResourceV1210Identifier_DurableNameFormat, using the provided ResourceV1210IdentifierDurableNameFormat1
func (t *ResourceV1210Identifier_DurableNameFormat) MergeResourceV1210IdentifierDurableNameFormat1(v ResourceV1210IdentifierDurableNameFormat1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ResourceV1210Identifier_DurableNameFormat) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ResourceV1210Identifier_DurableNameFormat) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceV1210ContactInfo returns the union data inside the ResourceV1210Location_Contacts_Item as a ResourceV1210ContactInfo
func (t ResourceV1210Location_Contacts_Item) AsResourceV1210ContactInfo() (ResourceV1210ContactInfo, error) {
	var body ResourceV1210ContactInfo
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210ContactInfo overwrites any union data inside the ResourceV1210Location_Contacts_Item as the provided ResourceV1210ContactInfo
func (t *ResourceV1210Location_Contacts_Item) FromResourceV1210ContactInfo(v ResourceV1210ContactInfo) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210ContactInfo performs a merge with any union data inside the ResourceV1210Location_Contacts_Item, using the provided ResourceV1210ContactInfo
func (t *ResourceV1210Location_Contacts_Item) MergeResourceV1210ContactInfo(v ResourceV1210ContactInfo) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsResourceV1210LocationContacts1 returns the union data inside the ResourceV1210Location_Contacts_Item as a ResourceV1210LocationContacts1
func (t ResourceV1210Location_Contacts_Item) AsResourceV1210LocationContacts1() (ResourceV1210LocationContacts1, error) {
	var body ResourceV1210LocationContacts1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210LocationContacts1 overwrites any union data inside the ResourceV1210Location_Contacts_Item as the provided ResourceV1210LocationContacts1
func (t *ResourceV1210Location_Contacts_Item) FromResourceV1210LocationContacts1(v ResourceV1210LocationContacts1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210LocationContacts1 performs a merge with any union data inside the ResourceV1210Location_Contacts_Item, using the provided ResourceV1210LocationContacts1
func (t *ResourceV1210Location_Contacts_Item) MergeResourceV1210LocationContacts1(v ResourceV1210LocationContacts1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ResourceV1210Location_Contacts_Item) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ResourceV1210Location_Contacts_Item) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceV1210LocationType returns the union data inside the ResourceV1210PartLocation_LocationType as a ResourceV1210LocationType
func (t ResourceV1210PartLocation_LocationType) AsResourceV1210LocationType() (ResourceV1210LocationType, error) {
	var body ResourceV1210LocationType
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210LocationType overwrites any union data inside the ResourceV1210PartLocation_LocationType as the provided ResourceV1210LocationType
func (t *ResourceV1210PartLocation_LocationType) FromResourceV1210LocationType(v ResourceV1210LocationType) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210LocationType performs a merge with any union data inside the ResourceV1210PartLocation_LocationType, using the provided ResourceV1210LocationType
func (t *ResourceV1210PartLocation_LocationType) MergeResourceV1210LocationType(v ResourceV1210LocationType) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsResourceV1210PartLocationLocationType1 returns the union data inside the ResourceV1210PartLocation_LocationType as a ResourceV1210PartLocationLocationType1
func (t ResourceV1210PartLocation_LocationType) AsResourceV1210PartLocationLocationType1() (ResourceV1210PartLocationLocationType1, error) {
	var body ResourceV1210PartLocationLocationType1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210PartLocationLocationType1 overwrites any union data inside the ResourceV1210PartLocation_LocationType as the provided ResourceV1210PartLocationLocationType1
func (t *ResourceV1210PartLocation_LocationType) FromResourceV1210PartLocationLocationType1(v ResourceV1210PartLocationLocationType1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210PartLocationLocationType1 performs a merge with any union data inside the ResourceV1210PartLocation_LocationType, using the provided ResourceV1210PartLocationLocationType1
func (t *ResourceV1210PartLocation_LocationType) MergeResourceV1210PartLocationLocationType1(v ResourceV1210PartLocationLocationType1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ResourceV1210PartLocation_LocationType) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ResourceV1210PartLocation_LocationType) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceV1210Orientation returns the union data inside the ResourceV1210PartLocation_Orientation as a ResourceV1210Orientation
func (t ResourceV1210PartLocation_Orientation) AsResourceV1210Orientation() (ResourceV1210Orientation, error) {
	var body ResourceV1210Orientation
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210Orientation overwrites any union data inside the ResourceV1210PartLocation_Orientation as the provided ResourceV1210Orientation
func (t *ResourceV1210PartLocation_Orientation) FromResourceV1210Orientation(v ResourceV1210Orientation) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210Orientation performs a merge with any union data inside the ResourceV1210PartLocation_Orientation, using the provided ResourceV1210Orientation
func (t *ResourceV1210PartLocation_Orientation) MergeResourceV1210Orientation(v ResourceV1210Orientation) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsResourceV1210PartLocationOrientation1 returns the union data inside the ResourceV1210PartLocation_Orientation as a ResourceV1210PartLocationOrientation1
func (t ResourceV1210PartLocation_Orientation) AsResourceV1210PartLocationOrientation1() (ResourceV1210PartLocationOrientation1, error) {
	var body ResourceV1210PartLocationOrientation1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210PartLocationOrientation1 overwrites any union data inside the ResourceV1210PartLocation_Orientation as the provided ResourceV1210PartLocationOrientation1
func (t *ResourceV1210PartLocation_Orientation) FromResourceV1210PartLocationOrientation1(v ResourceV1210PartLocationOrientation1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210PartLocationOrientation1 performs a merge with any union data inside the ResourceV1210PartLocation_Orientation, using the provided ResourceV1210PartLocationOrientation1
func (t *ResourceV1210PartLocation_Orientation) MergeResourceV1210PartLocationOrientation1(v ResourceV1210PartLocationOrientation1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ResourceV1210PartLocation_Orientation) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ResourceV1210PartLocation_Orientation) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceV1210Reference returns the union data inside the ResourceV1210PartLocation_Reference as a ResourceV1210Reference
func (t ResourceV1210PartLocation_Reference) AsResourceV1210Reference() (ResourceV1210Reference, error) {
	var body ResourceV1210Reference
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210Reference overwrites any union data inside the ResourceV1210PartLocation_Reference as the provided ResourceV1210Reference
func (t *ResourceV1210PartLocation_Reference) FromResourceV1210Reference(v ResourceV1210Reference) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210Reference performs a merge with any union data inside the ResourceV1210PartLocation_Reference, using the provided ResourceV1210Reference
func (t *ResourceV1210PartLocation_Reference) MergeResourceV1210Reference(v ResourceV1210Reference) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsResourceV1210PartLocationReference1 returns the union data inside the ResourceV1210PartLocation_Reference as a ResourceV1210PartLocationReference1
func (t ResourceV1210PartLocation_Reference) AsResourceV1210PartLocationReference1() (ResourceV1210PartLocationReference1, error) {
	var body ResourceV1210PartLocationReference1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210PartLocationReference1 overwrites any union data inside the ResourceV1210PartLocation_Reference as the provided ResourceV1210PartLocationReference1
func (t *ResourceV1210PartLocation_Reference) FromResourceV1210PartLocationReference1(v ResourceV1210PartLocationReference1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210PartLocationReference1 performs a merge with any union data inside the ResourceV1210PartLocation_Reference, using the provided ResourceV1210PartLocationReference1
func (t *ResourceV1210PartLocation_Reference) MergeResourceV1210PartLocationReference1(v ResourceV1210PartLocationReference1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ResourceV1210PartLocation_Reference) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ResourceV1210PartLocation_Reference) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceV1210RackUnits returns the union data inside the ResourceV1210Placement_RackOffsetUnits as a ResourceV1210RackUnits
func (t ResourceV1210Placement_RackOffsetUnits) AsResourceV1210RackUnits() (ResourceV1210RackUnits, error) {
	var body ResourceV1210RackUnits
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210RackUnits overwrites any union data inside the ResourceV1210Placement_RackOffsetUnits as the provided ResourceV1210RackUnits
func (t *ResourceV1210Placement_RackOffsetUnits) FromResourceV1210RackUnits(v ResourceV1210RackUnits) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210RackUnits performs a merge with any union data inside the ResourceV1210Placement_RackOffsetUnits, using the provided ResourceV1210RackUnits
func (t *ResourceV1210Placement_RackOffsetUnits) MergeResourceV1210RackUnits(v ResourceV1210RackUnits) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsResourceV1210PlacementRackOffsetUnits1 returns the union data inside the ResourceV1210Placement_RackOffsetUnits as a ResourceV1210PlacementRackOffsetUnits1
func (t ResourceV1210Placement_RackOffsetUnits) AsResourceV1210PlacementRackOffsetUnits1() (ResourceV1210PlacementRackOffsetUnits1, error) {
	var body ResourceV1210PlacementRackOffsetUnits1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceV1210PlacementRackOffsetUnits1 overwrites any union data inside the ResourceV1210Placement_RackOffsetUnits as the provided ResourceV1210PlacementRackOffsetUnits1
func (t *ResourceV1210Placement_RackOffsetUnits) FromResourceV1210PlacementRackOffsetUnits1(v ResourceV1210PlacementRackOffsetUnits1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceV1210PlacementRackOffsetUnits1 performs a merge with any union data inside the ResourceV1210Placement_RackOffsetUnits, using the provided ResourceV1210PlacementRackOffsetUnits1
func (t *ResourceV1210Placement_RackOffsetUnits) MergeResourceV1210PlacementRackOffsetUnits1(v ResourceV1210PlacementRackOffsetUnits1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ResourceV1210Placement_RackOffsetUnits) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ResourceV1210Placement_RackOffsetUnits) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceDescription returns the union data inside the StorageControllerCollectionStorageControllerCollection_Description as a ResourceDescription
func (t StorageControllerCollectionStorageControllerCollection_Description) AsResourceDescription() (ResourceDescription, error) {
	var body ResourceDescription
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceDescription overwrites any union data inside the StorageControllerCollectionStorageControllerCollection_Description as the provided ResourceDescription
func (t *StorageControllerCollectionStorageControllerCollection_Description) FromResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceDescription performs a merge with any union data inside the StorageControllerCollectionStorageControllerCollection_Description, using the provided ResourceDescription
func (t *StorageControllerCollectionStorageControllerCollection_Description) MergeResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerCollectionStorageControllerCollectionDescription1 returns the union data inside the StorageControllerCollectionStorageControllerCollection_Description as a StorageControllerCollectionStorageControllerCollectionDescription1
func (t StorageControllerCollectionStorageControllerCollection_Description) AsStorageControllerCollectionStorageControllerCollectionDescription1() (StorageControllerCollectionStorageControllerCollectionDescription1, error) {
	var body StorageControllerCollectionStorageControllerCollectionDescription1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerCollectionStorageControllerCollectionDescription1 overwrites any union data inside the StorageControllerCollectionStorageControllerCollection_Description as the provided StorageControllerCollectionStorageControllerCollectionDescription1
func (t *StorageControllerCollectionStorageControllerCollection_Description) FromStorageControllerCollectionStorageControllerCollectionDescription1(v StorageControllerCollectionStorageControllerCollectionDescription1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerCollectionStorageControllerCollectionDescription1 performs a merge with any union data inside the StorageControllerCollectionStorageControllerCollection_Description, using the provided StorageControllerCollectionStorageControllerCollectionDescription1
func (t *StorageControllerCollectionStorageControllerCollection_Description) MergeStorageControllerCollectionStorageControllerCollectionDescription1(v StorageControllerCollectionStorageControllerCollectionDescription1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerCollectionStorageControllerCollection_Description) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerCollectionStorageControllerCollection_Description) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsStorageControllerV191ANAAccessState returns the union data inside the StorageControllerV191ANACharacteristics_AccessState as a StorageControllerV191ANAAccessState
func (t StorageControllerV191ANACharacteristics_AccessState) AsStorageControllerV191ANAAccessState() (StorageControllerV191ANAAccessState, error) {
	var body StorageControllerV191ANAAccessState
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191ANAAccessState overwrites any union data inside the StorageControllerV191ANACharacteristics_AccessState as the provided StorageControllerV191ANAAccessState
func (t *StorageControllerV191ANACharacteristics_AccessState) FromStorageControllerV191ANAAccessState(v StorageControllerV191ANAAccessState) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191ANAAccessState performs a merge with any union data inside the StorageControllerV191ANACharacteristics_AccessState, using the provided StorageControllerV191ANAAccessState
func (t *StorageControllerV191ANACharacteristics_AccessState) MergeStorageControllerV191ANAAccessState(v StorageControllerV191ANAAccessState) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191ANACharacteristicsAccessState1 returns the union data inside the StorageControllerV191ANACharacteristics_AccessState as a StorageControllerV191ANACharacteristicsAccessState1
func (t StorageControllerV191ANACharacteristics_AccessState) AsStorageControllerV191ANACharacteristicsAccessState1() (StorageControllerV191ANACharacteristicsAccessState1, error) {
	var body StorageControllerV191ANACharacteristicsAccessState1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191ANACharacteristicsAccessState1 overwrites any union data inside the StorageControllerV191ANACharacteristics_AccessState as the provided StorageControllerV191ANACharacteristicsAccessState1
func (t *StorageControllerV191ANACharacteristics_AccessState) FromStorageControllerV191ANACharacteristicsAccessState1(v StorageControllerV191ANACharacteristicsAccessState1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191ANACharacteristicsAccessState1 performs a merge with any union data inside the StorageControllerV191ANACharacteristics_AccessState, using the provided StorageControllerV191ANACharacteristicsAccessState1
func (t *StorageControllerV191ANACharacteristics_AccessState) MergeStorageControllerV191ANACharacteristicsAccessState1(v StorageControllerV191ANACharacteristicsAccessState1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191ANACharacteristics_AccessState) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191ANACharacteristics_AccessState) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsStorageControllerV191ANACharacteristics returns the union data inside the StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item as a StorageControllerV191ANACharacteristics
func (t StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) AsStorageControllerV191ANACharacteristics() (StorageControllerV191ANACharacteristics, error) {
	var body StorageControllerV191ANACharacteristics
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191ANACharacteristics overwrites any union data inside the StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item as the provided StorageControllerV191ANACharacteristics
func (t *StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) FromStorageControllerV191ANACharacteristics(v StorageControllerV191ANACharacteristics) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191ANACharacteristics performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item, using the provided StorageControllerV191ANACharacteristics
func (t *StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) MergeStorageControllerV191ANACharacteristics(v StorageControllerV191ANACharacteristics) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191NVMeControllerPropertiesANACharacteristics1 returns the union data inside the StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item as a StorageControllerV191NVMeControllerPropertiesANACharacteristics1
func (t StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) AsStorageControllerV191NVMeControllerPropertiesANACharacteristics1() (StorageControllerV191NVMeControllerPropertiesANACharacteristics1, error) {
	var body StorageControllerV191NVMeControllerPropertiesANACharacteristics1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191NVMeControllerPropertiesANACharacteristics1 overwrites any union data inside the StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item as the provided StorageControllerV191NVMeControllerPropertiesANACharacteristics1
func (t *StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) FromStorageControllerV191NVMeControllerPropertiesANACharacteristics1(v StorageControllerV191NVMeControllerPropertiesANACharacteristics1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191NVMeControllerPropertiesANACharacteristics1 performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item, using the provided StorageControllerV191NVMeControllerPropertiesANACharacteristics1
func (t *StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) MergeStorageControllerV191NVMeControllerPropertiesANACharacteristics1(v StorageControllerV191NVMeControllerPropertiesANACharacteristics1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191NVMeControllerProperties_ANACharacteristics_Item) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsStorageControllerV191NVMeControllerType returns the union data inside the StorageControllerV191NVMeControllerProperties_ControllerType as a StorageControllerV191NVMeControllerType
func (t StorageControllerV191NVMeControllerProperties_ControllerType) AsStorageControllerV191NVMeControllerType() (StorageControllerV191NVMeControllerType, error) {
	var body StorageControllerV191NVMeControllerType
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191NVMeControllerType overwrites any union data inside the StorageControllerV191NVMeControllerProperties_ControllerType as the provided StorageControllerV191NVMeControllerType
func (t *StorageControllerV191NVMeControllerProperties_ControllerType) FromStorageControllerV191NVMeControllerType(v StorageControllerV191NVMeControllerType) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191NVMeControllerType performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_ControllerType, using the provided StorageControllerV191NVMeControllerType
func (t *StorageControllerV191NVMeControllerProperties_ControllerType) MergeStorageControllerV191NVMeControllerType(v StorageControllerV191NVMeControllerType) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191NVMeControllerPropertiesControllerType1 returns the union data inside the StorageControllerV191NVMeControllerProperties_ControllerType as a StorageControllerV191NVMeControllerPropertiesControllerType1
func (t StorageControllerV191NVMeControllerProperties_ControllerType) AsStorageControllerV191NVMeControllerPropertiesControllerType1() (StorageControllerV191NVMeControllerPropertiesControllerType1, error) {
	var body StorageControllerV191NVMeControllerPropertiesControllerType1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191NVMeControllerPropertiesControllerType1 overwrites any union data inside the StorageControllerV191NVMeControllerProperties_ControllerType as the provided StorageControllerV191NVMeControllerPropertiesControllerType1
func (t *StorageControllerV191NVMeControllerProperties_ControllerType) FromStorageControllerV191NVMeControllerPropertiesControllerType1(v StorageControllerV191NVMeControllerPropertiesControllerType1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191NVMeControllerPropertiesControllerType1 performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_ControllerType, using the provided StorageControllerV191NVMeControllerPropertiesControllerType1
func (t *StorageControllerV191NVMeControllerProperties_ControllerType) MergeStorageControllerV191NVMeControllerPropertiesControllerType1(v StorageControllerV191NVMeControllerPropertiesControllerType1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191NVMeControllerProperties_ControllerType) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191NVMeControllerProperties_ControllerType) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsStorageControllerV191NVMeControllerAttributes returns the union data inside the StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes as a StorageControllerV191NVMeControllerAttributes
func (t StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) AsStorageControllerV191NVMeControllerAttributes() (StorageControllerV191NVMeControllerAttributes, error) {
	var body StorageControllerV191NVMeControllerAttributes
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191NVMeControllerAttributes overwrites any union data inside the StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes as the provided StorageControllerV191NVMeControllerAttributes
func (t *StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) FromStorageControllerV191NVMeControllerAttributes(v StorageControllerV191NVMeControllerAttributes) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191NVMeControllerAttributes performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes, using the provided StorageControllerV191NVMeControllerAttributes
func (t *StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) MergeStorageControllerV191NVMeControllerAttributes(v StorageControllerV191NVMeControllerAttributes) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1 returns the union data inside the StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes as a StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1
func (t StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) AsStorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1() (StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1, error) {
	var body StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1 overwrites any union data inside the StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes as the provided StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1
func (t *StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) FromStorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1(v StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1 performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes, using the provided StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1
func (t *StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) MergeStorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1(v StorageControllerV191NVMeControllerPropertiesNVMeControllerAttributes1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191NVMeControllerProperties_NVMeControllerAttributes) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsStorageControllerV191NVMeSMARTCriticalWarnings returns the union data inside the StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings as a StorageControllerV191NVMeSMARTCriticalWarnings
func (t StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) AsStorageControllerV191NVMeSMARTCriticalWarnings() (StorageControllerV191NVMeSMARTCriticalWarnings, error) {
	var body StorageControllerV191NVMeSMARTCriticalWarnings
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191NVMeSMARTCriticalWarnings overwrites any union data inside the StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings as the provided StorageControllerV191NVMeSMARTCriticalWarnings
func (t *StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) FromStorageControllerV191NVMeSMARTCriticalWarnings(v StorageControllerV191NVMeSMARTCriticalWarnings) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191NVMeSMARTCriticalWarnings performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings, using the provided StorageControllerV191NVMeSMARTCriticalWarnings
func (t *StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) MergeStorageControllerV191NVMeSMARTCriticalWarnings(v StorageControllerV191NVMeSMARTCriticalWarnings) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1 returns the union data inside the StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings as a StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1
func (t StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) AsStorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1() (StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1, error) {
	var body StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1 overwrites any union data inside the StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings as the provided StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1
func (t *StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) FromStorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1(v StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1 performs a merge with any union data inside the StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings, using the provided StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1
func (t *StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) MergeStorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1(v StorageControllerV191NVMeControllerPropertiesNVMeSMARTCriticalWarnings1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191NVMeControllerProperties_NVMeSMARTCriticalWarnings) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsResourceDescription returns the union data inside the StorageControllerV191StorageController_Description as a ResourceDescription
func (t StorageControllerV191StorageController_Description) AsResourceDescription() (ResourceDescription, error) {
	var body ResourceDescription
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromResourceDescription overwrites any union data inside the StorageControllerV191StorageController_Description as the provided ResourceDescription
func (t *StorageControllerV191StorageController_Description) FromResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeResourceDescription performs a merge with any union data inside the StorageControllerV191StorageController_Description, using the provided ResourceDescription
func (t *StorageControllerV191StorageController_Description) MergeResourceDescription(v ResourceDescription) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191StorageControllerDescription1 returns the union data inside the StorageControllerV191StorageController_Description as a StorageControllerV191StorageControllerDescription1
func (t StorageControllerV191StorageController_Description) AsStorageControllerV191StorageControllerDescription1() (StorageControllerV191StorageControllerDescription1, error) {
	var body StorageControllerV191StorageControllerDescription1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191StorageControllerDescription1 overwrites any union data inside the StorageControllerV191StorageController_Description as the provided StorageControllerV191StorageControllerDescription1
func (t *StorageControllerV191StorageController_Description) FromStorageControllerV191StorageControllerDescription1(v StorageControllerV191StorageControllerDescription1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191StorageControllerDescription1 performs a merge with any union data inside the StorageControllerV191StorageController_Description, using the provided StorageControllerV191StorageControllerDescription1
func (t *StorageControllerV191StorageController_Description) MergeStorageControllerV191StorageControllerDescription1(v StorageControllerV191StorageControllerDescription1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191StorageController_Description) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191StorageController_Description) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsOdataV4IdRef returns the union data inside the StorageControllerV191StorageController_Metrics as a OdataV4IdRef
func (t StorageControllerV191StorageController_Metrics) AsOdataV4IdRef() (OdataV4IdRef, error) {
	var body OdataV4IdRef
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromOdataV4IdRef overwrites any union data inside the StorageControllerV191StorageController_Metrics as the provided OdataV4IdRef
func (t *StorageControllerV191StorageController_Metrics) FromOdataV4IdRef(v OdataV4IdRef) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeOdataV4IdRef performs a merge with any union data inside the StorageControllerV191StorageController_Metrics, using the provided OdataV4IdRef
func (t *StorageControllerV191StorageController_Metrics) MergeOdataV4IdRef(v OdataV4IdRef) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191StorageControllerMetrics1 returns the union data inside the StorageControllerV191StorageController_Metrics as a StorageControllerV191StorageControllerMetrics1
func (t StorageControllerV191StorageController_Metrics) AsStorageControllerV191StorageControllerMetrics1() (StorageControllerV191StorageControllerMetrics1, error) {
	var body StorageControllerV191StorageControllerMetrics1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191StorageControllerMetrics1 overwrites any union data inside the StorageControllerV191StorageController_Metrics as the provided StorageControllerV191StorageControllerMetrics1
func (t *StorageControllerV191StorageController_Metrics) FromStorageControllerV191StorageControllerMetrics1(v StorageControllerV191StorageControllerMetrics1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191StorageControllerMetrics1 performs a merge with any union data inside the StorageControllerV191StorageController_Metrics, using the provided StorageControllerV191StorageControllerMetrics1
func (t *StorageControllerV191StorageController_Metrics) MergeStorageControllerV191StorageControllerMetrics1(v StorageControllerV191StorageControllerMetrics1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191StorageController_Metrics) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191StorageController_Metrics) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsVolumeRAIDType returns the union data inside the StorageControllerV191StorageController_SupportedRAIDTypes_Item as a VolumeRAIDType
func (t StorageControllerV191StorageController_SupportedRAIDTypes_Item) AsVolumeRAIDType() (VolumeRAIDType, error) {
	var body VolumeRAIDType
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromVolumeRAIDType overwrites any union data inside the StorageControllerV191StorageController_SupportedRAIDTypes_Item as the provided VolumeRAIDType
func (t *StorageControllerV191StorageController_SupportedRAIDTypes_Item) FromVolumeRAIDType(v VolumeRAIDType) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeVolumeRAIDType performs a merge with any union data inside the StorageControllerV191StorageController_SupportedRAIDTypes_Item, using the provided VolumeRAIDType
func (t *StorageControllerV191StorageController_SupportedRAIDTypes_Item) MergeVolumeRAIDType(v VolumeRAIDType) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsStorageControllerV191StorageControllerSupportedRAIDTypes1 returns the union data inside the StorageControllerV191StorageController_SupportedRAIDTypes_Item as a StorageControllerV191StorageControllerSupportedRAIDTypes1
func (t StorageControllerV191StorageController_SupportedRAIDTypes_Item) AsStorageControllerV191StorageControllerSupportedRAIDTypes1() (StorageControllerV191StorageControllerSupportedRAIDTypes1, error) {
	var body StorageControllerV191StorageControllerSupportedRAIDTypes1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromStorageControllerV191StorageControllerSupportedRAIDTypes1 overwrites any union data inside the StorageControllerV191StorageController_SupportedRAIDTypes_Item as the provided StorageControllerV191StorageControllerSupportedRAIDTypes1
func (t *StorageControllerV191StorageController_SupportedRAIDTypes_Item) FromStorageControllerV191StorageControllerSupportedRAIDTypes1(v StorageControllerV191StorageControllerSupportedRAIDTypes1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeStorageControllerV191StorageControllerSupportedRAIDTypes1 performs a merge with any union data inside the StorageControllerV191StorageController_SupportedRAIDTypes_Item, using the provided StorageControllerV191StorageControllerSupportedRAIDTypes1
func (t *StorageControllerV191StorageController_SupportedRAIDTypes_Item) MergeStorageControllerV191StorageControllerSupportedRAIDTypes1(v StorageControllerV191StorageControllerSupportedRAIDTypes1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t StorageControllerV191StorageController_SupportedRAIDTypes_Item) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *StorageControllerV191StorageController_SupportedRAIDTypes_Item) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
